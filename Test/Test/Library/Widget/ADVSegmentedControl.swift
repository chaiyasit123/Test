...
class ADVSegmentedControl: UIControl {
    ...
    @IBInspectable var isThumbCircle : Bool = false
...
//        backgroundColor = UIColor.clear
    ...
    func setupLabels(){
        ...
        var name = Constant.FONT_EN_BOLD_NAME
        var extraSize: CGFloat = 0
        if language == "th" {
            name = Constant.FONT_TH_BOLD_NAME
            extraSize = CGFloat(Constant.FONT_TH_EXTRA_SIZE)
        }
        ...
        for index in 1...items.count {
            ...
            label.font = UIFont(name: name, size: 15 + extraSize)
