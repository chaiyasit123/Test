...
open class TTSegmentedControl: UIView {
    ...
    @IBInspectable open var defaultTextFont: UIFont = UIFont.helveticaNeueLight(15)
    @IBInspectable open var selectedTextFont: UIFont = UIFont.helveticaNeueLight(15)
    ...
    @IBInspectable open var containerBackgroundColor1: UIColor!
    @IBInspectable open var containerBackgroundColor2: UIColor!
    @IBInspectable open var containerCornerRadius: CGFloat = -1
    
    @IBInspectable open var thumbColor: UIColor = UIColor.clear
    @IBInspectable open var thumbGradientColor1: UIColor!
    @IBInspectable open var thumbGradientColor2: UIColor!
    ...
    @IBInspectable open var thumbPadding: CGFloat = 2
    ...
    open override func awakeFromNib() {
        ...
        let textArr = localizedText.components(separatedBy: ",")
        for i in 0..<textArr.count {
            itemTitles.append(textArr[i].localized())
        }
    }
    ...
    open override func layoutSubviews() {
        ...
        containerView.layer.cornerRadius = containerCornerRadius < 0 ? 0.5 * containerView.frame.size.height : containerCornerRadius
        self.layer.cornerRadius = containerCornerRadius < 0 ? 0.5 * containerView.frame.size.height : containerCornerRadius
...
extension TTSegmentedControl {
    ...
    fileprivate func configureSelectedView() {
        ...
        if thumbGradientColor1 != nil && thumbGradientColor2 != nil && self.useGradient {
            gradientLayer.startPoint = CGPoint(x: 0.5, y: 0.0)
            gradientLayer.endPoint = CGPoint(x: 0.5, y: 1.0)
            gradientLayer.backgroundColor = thumbColor.cgColor
            gradientLayer.colors = [thumbGradientColor1.cgColor, thumbGradientColor2.cgColor]
    ...
    fileprivate func configureContainerView() {
        if self.useGradient {
            ...
            bgGradientLayer.backgroundColor = containerBackgroundColor1.cgColor
            bgGradientLayer.colors = [containerBackgroundColor1.cgColor, containerBackgroundColor2.cgColor]
            bgGradientLayer.frame = self.bounds
            containerView.backgroundColor = UIColor.clear
            containerView.layer.insertSublayer(bgGradientLayer, at: 0)
        } else {
            containerView.backgroundColor = containerBackgroundColor1
        }
    ...
    fileprivate func createLabelWithTitle(_ attributedTitle: NSAttributedString, tag: Int) -> UILabel {
        ...
        var name = Constant.FONT_EN_NAME
        var extranSize = 0
        if language == "th" {
        ...
        label.font = UIFont(name: name, size: (label.font.pointSize) + CGFloat(extranSize))
        label.tag = tag
        return label
    }
